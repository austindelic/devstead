...
public class ScreenSpaceReflectionURP : ScriptableRendererFeature
{
    ...
    public class Unity6ScreenSpaceReflectionPass : ScriptableRenderPass
    {
        ...
        {
            if (volume.quality.value == ScreenSpaceReflection.Quality.Low)
            {
                ssrMaterial.SetFloat(stepSize, 0.4f);
                ssrMaterial.SetFloat(stepSizeMultiplier, 1.33f);
                ssrMaterial.SetFloat(maxStep, 16);
            }
            else if (volume.quality.value == ScreenSpaceReflection.Quality.Medium)
            {
                ssrMaterial.SetFloat(stepSize, 0.3f);
                ssrMaterial.SetFloat(stepSizeMultiplier, 1.33f);
                ssrMaterial.SetFloat(maxStep, 32);
            }
            else if (volume.quality.value == ScreenSpaceReflection.Quality.High)
            {
            ...
            else
            {
                ...
                ssrMaterial.SetFloat(maxStep, volume.maxStep.value);
            }

            ssrMaterial.SetFloat(minSmoothness, volume.minSmoothness.value);
            ssrMaterial.SetFloat(fadeSmoothness, volume.fadeSmoothness.value <= volume.minSmoothness.value ? volume.minSmoothness.value + 0.01f : volume.fadeSmoothness.value);
            ssrMaterial.SetFloat(edgeFade, volume.edgeFade.value);
            ssrMaterial.SetFloat(thickness, volume.thickness.value);
