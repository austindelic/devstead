...
public class ScreenSpaceGlobalIlluminationURP : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        ScreenSpaceGlobalIlluminationVolume ssgiVolume = stack == null ? null : stack.GetComponent<ScreenSpaceGlobalIlluminationVolume>();
        ...
        shouldDisable |= ssgiVolume == null || (ssgiVolume.indirectDiffuseLightingMultiplier.value == 0.0f && !m_OverrideAmbientLighting);
